...
<body>
	<div class="ibody">
		...
		<form name=search action="SearchServlet" method=post>
  			...
  			<input  style="font: 20px arial; width:400px; height:50px;  padding:3px" type="text" name="searchtext" maxlength=50%/>
 			<input type="submit" style="height:40px; font: 25px kaiti;" value="搜索" />
 			</div>
 		</form>		
